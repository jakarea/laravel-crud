...
<div class="container">
  <div class="grid_1">
	 <h3>Featured Employers</h3>
	   <div class="nbs-flexisel-container"><div class="nbs-flexisel-inner"><ul id="flexiselDemo3" class="nbs-flexisel-ul" style="left: -153.833px;">
	      <li class="nbs-flexisel-item" style="width: 153.833px;">
	      	{!! Html::image('assets/images/c6.gif') !!}</li><li class="nbs-flexisel-item" style="width: 153.833px;">{!! Html::image('assets/images/c1.gif') !!}</li>
	    ...
	    <li class="nbs-flexisel-item" style="width: 153.833px;">{!! Html::image('assets/images/c1.gif') !!}</li><li class="nbs-flexisel-item" style="width: 153.833px;">{!! Html::image('assets/images/c2.gif') !!}</li><li class="nbs-flexisel-item" style="width: 153.833px;">{!! Html::image('assets/images/c3.gif') !!}</li><li class="nbs-flexisel-item" style="width: 153.833px;">{!! Html::image('assets/images/c4.gif') !!}</li><li class="nbs-flexisel-item" style="width: 153.833px;">{!! Html::image('assets/images/c5.gif') !!}</li></ul><div class="nbs-flexisel-nav-left" style="top: -10px;"></div><div class="nbs-flexisel-nav-right" style="top: -10px;"></div></div></div>
	   ...
	   <div class="col-md-8">
	      <div class="col_1">
   	        <div class="col-sm-4 row_2">
				<a href="single.html">{!! Html::image('assets/images/a1.jpg','',array('class'=>'img-responsive')) !!}</a>
			</div>
		   ...
		   <div class="col_1">
   	         <div class="col-sm-4 row_2">
				<a href="single.html">{!! Html::image('assets/images/a2.jpg','',array('class'=>'img-responsive')) !!}</a>
			</div>
			<div class="col-sm-8 row_1">
		   ...
		   <div class="col_1">
   	        <div class="col-sm-4 row_2">
				<a href="single.html">{!! Html::image('assets/images/a3.jpg','',array('class'=>'img-responsive')) !!}</a>
			</div>
			<div class="col-sm-8 row_1">
		   ...
		   <div class="col_1">
   	         <div class="col-sm-4 row_2">
				<a href="single.html">{!! Html::image('assets/images/a4.jpg','',array('class'=>'img-responsive')) !!}</a>
			</div>
			<div class="col-sm-8 row_1">
		   ...
		   <div class="col_1">
   	         <div class="col-sm-4 row_2">
				<a href="single.html">{!! Html::image('assets/images/a5.jpg','',array('class'=>'img-responsive')) !!}</a>
			</div>
			<div class="col-sm-8 row_1">
		   ...
		   <div class="col_2">
   	         <div class="col-sm-4 row_2">
				<a href="single.html">{!! Html::image('assets/images/a6.jpg','',array('class'=>'img-responsive')) !!}</a>
			</div>
			<div class="col-sm-8 row_1">
